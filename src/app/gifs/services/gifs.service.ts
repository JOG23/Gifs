...
export class GifService {
  ...
  searchHistory=signal<Record<string,Gif[]>>(loadFromLocalStorage()); //Tipaddo Record
  searchHistoryKeys=computed(()=>Object.keys(this.searchHistory()));//Señales computadas
...
//Aqui grabamos en el LocalStorage
...
searchGifs(query: string): Observable<Gif[]>{ //regresa un obervable
